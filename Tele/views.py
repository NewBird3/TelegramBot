...
def send_messages(message, token):
    ...
    post_message_url = "https://api.telegram.org/bot1994323972:AAHY86fPQJMP_YVlh29-WiaWDz9hg2Fup1c/sendMessage".format(token)
...
class TelegramBotView(generic.View):
    ...
    def post(self, request, *args, **kwargs):
        TELEGRAM_TOKEN = '1994323972:AAHY86fPQJMP_YVlh29-WiaWDz9hg2Fup1c' #Token added from BotFather
